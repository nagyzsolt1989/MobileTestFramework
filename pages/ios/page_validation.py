...
class ValidationPage(BasePage):
    ...
    input_adjective = (MobileBy.XPATH, "//XCUIElementTypeTextField[1]")
    input_noun = (MobileBy.XPATH, "//XCUIElementTypeTextField[2]")
    checkbox_terms_of_service = (MobileBy.XPATH, "//XCUIElementTypeSwitch")
